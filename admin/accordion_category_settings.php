...
function accordion_category_default_roles_render()
{
...
function check_for_retroactive_application()
{
...
add_action('admin_init', 'check_for_retroactive_application');

// Function to display the admin notice
function acd_show_retroactive_application_notice()
{
...
add_action('admin_notices', 'acd_show_retroactive_application_notice');
