...
class ShortcodeHandlers{
    public function init() {
        add_shortcode('document_category_list', array($this, 'document_category_list_shortcode'));
        add_action('document_category_edit_form_fields', array($this, 'acd_add_role_selection_to_category'));
        add_action('created_document_category', array($this, 'acd_save_allowed_roles'));
        add_action('edited_document_category', array($this, 'acd_save_allowed_roles'));
    }

    
    //Shortcode generator
    public function document_category_list_shortcode() {
        $output = '';
        ...
        if (!empty($parent_categories) && !is_wp_error($parent_categories)) {
            ...
            foreach ($parent_categories as $category) {
                $category_output = $this->display_category_with_posts($category->term_id, true);
        ...
        if ($query->have_posts() || !empty($subcategories)) {
            ...
            if (!empty($subcategories)) {
                ...
                foreach ($subcategories as $subcategory) {
                    ...
                    $sub_output = $this->display_category_with_posts($subcategory->term_id);
                    if (!empty($sub_output)) {
    ...
    public function acd_add_role_selection_to_category($term)
    {
    ...
    public function acd_save_allowed_roles($term_id)
    {
